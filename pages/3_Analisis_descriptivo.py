...
with col1:
    ...
    with open('HTML/5_precio_grupovecinos.html', 'r') as file:
...
with col2:
    ...
    with open('HTML/6_camas_tipohabitacion.html', 'r') as file:
        html_content = file.read()
    components.html(html_content, height=700) 
st.write('')
col1, col2 = st.columns(2)
with col1:
    ...
    with open('HTML/7_evolucion_preciohabitacion.html', 'r') as file:
        html_content = file.read()
...
with col2:
    ...
    with open('HTML/8_grupos_vecinos.html', 'r') as file:
        html_content = file.read()

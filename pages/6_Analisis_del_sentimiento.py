...
with col1:
    st.markdown('##### TOP_200')
    st.image('/Users/juliobrionesmorales/Documents/GitHub/Airbnb_Barcelona/img/8_numero comentarioi top200.png')
with col2:
    st.markdown('##### BOTTOM_200')
    st.image('/Users/juliobrionesmorales/Documents/GitHub/Airbnb_Barcelona/img/9_numero comentario bottom_200.png')
...
with col1:
    ...
    st.image('/Users/juliobrionesmorales/Documents/GitHub/Airbnb_Barcelona/img/wordcloud1.png')
with col2:
    st.markdown('##### BOTTOM_200')
    st.write('Mientras que las palabras más frecuentes en bottom_200 son: "great"-"place"-"host"-"but"-"had"-"todo"...')
    st.image('/Users/juliobrionesmorales/Documents/GitHub/Airbnb_Barcelona/img/wordcloud2.png')
...
with col1:
    st.markdown('##### TOP_200')
    st.image('/Users/juliobrionesmorales/Documents/GitHub/Airbnb_Barcelona/img/10_lenguage_description_top200.png')
with col2:
    st.markdown('##### BOTTOM_200')
    st.image('/Users/juliobrionesmorales/Documents/GitHub/Airbnb_Barcelona/img/11_language_description_bottom200.png')
...
with col1:
    ...
    st.image('/Users/juliobrionesmorales/Documents/GitHub/Airbnb_Barcelona/img/wordcloud3.png')
with col2:
    st.markdown('##### BOTTOM_200')
    ...
    st.image('/Users/juliobrionesmorales/Documents/GitHub/Airbnb_Barcelona/img/wordcloud4.png')

...
with col1:
    with open('HTML/1_outliers_price.html', 'r') as file:
        html_content = file.read()
    components.html(html_content,height=700)

with col2:
    with open('HTML/2_outliers_nights.html', 'r') as file:
        html_content = file.read()
    components.html(html_content, height=700) 
...
col1, col2 = st.columns(2)
with col1:
    with open('HTML/3_sinoutliers_price.html', 'r') as file:
        html_content = file.read()
    components.html(html_content,height=700)

with col2:
    with open('HTML/4_sinoutliers_nights.html', 'r') as file:
        html_content = file.read()
    components.html(html_content, height=700)
